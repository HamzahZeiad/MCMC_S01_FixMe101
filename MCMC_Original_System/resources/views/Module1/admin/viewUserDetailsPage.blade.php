...
<head>
    ...
    <meta name="description" content="Admin panel for viewing user profile details in the AuthenticityHub system" />
    <meta name="keywords" content="admin, user, profile, view, management, authenticity" />
    <meta name="author" content="AuthenticityHub" />
    <title>Admin – View User Profile | AuthenticityHub</title>
        ...
        <div class="main-content">
            ...
            <div class="profile-header">
                ...
                <div class="profile-info">
                    ...
                    <p class="subtitle">Public User • Member since {{ $stats['member_since'] }}</p>
                </div>
            </div>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">Completed Inquiries</div>
                </div>
            </div>
                ...
                <div class="section-content">
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">{{ $user->UserEmail ?? 'Not provided' }}</div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Phone Number</div>
                            <div class="info-value">{{ $user->UserPhoneNum ?? 'Not provided' }}</div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">{{ $user->created_at ? $user->created_at->format('M d, Y') : 'Unknown' }}</div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Last Updated</div>
                            <div class="info-value">{{ $user->updated_at ? $user->updated_at->format('M d, Y') : 'Unknown' }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="action-buttons">
                <a href="{{ route('admin.user.edit', $user->UserID) }}" class="btn btn-primary">
