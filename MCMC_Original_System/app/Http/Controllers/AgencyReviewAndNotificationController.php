...
class AgencyReviewAndNotificationController extends Controller
{
    ...
    public function showViewAndDisplayInquiry()
    {
        ...
        $inquiries = Inquiry::with(['user', 'agency', 'admin'])
            ...
            ->orderByRaw("
                CASE
                    -- BUG-M4-01: Priority ranks are REVERSED — High=3 (last) instead of High=1 (first)
                    -- Low-priority inquiries are displayed at the top, High-priority at the bottom
    ...
    public function rejectInquiry(Request $request, $id)
    {
        ...
        try {
            ...
            // BUG-M4-02: Separator changed from ' - ' to ' + ' — StatusComments stored incorrectly
            // Rejection reason and comments are concatenated with ' + ' making them hard to parse
