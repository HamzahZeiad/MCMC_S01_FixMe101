...
class InquiryController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            // BUG-M2-01: 'category' validation rule removed — any value (or blank) is accepted
            // 'category' => 'required|string',
            // BUG-M2-02: 'high' priority removed from allowed values — high-priority submissions silently fail validation
